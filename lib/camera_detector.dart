...
class _CameraDetectorState extends State<CameraDetector> with WidgetsBindingObserver {
  ...
  late bool _camPos = false; //FALSE means Front Camera and TRUE means Back Camera
        ...
        ScannerUtils.detect(
          ...
          */
            ...
            for (_face in results) {
              ...
              // authService.rekognition();

              if (_faceName == "No reconocido" || _faceName == "NO RECONOCIDO" || _faceName == "PERSONA NO RECONOCIDO") {
                //print('RESUL $res');
                if (!widget.externalValidation) {
                  await authService.changeStatus("off");
                } else {
  ...
  static imglib.Image _convertYUV420(CameraImage image, CameraLensDirection _dir) {
    ...
    var img1 = (_dir == CameraLensDirection.front) ? imglib.copyRotate(img, -90) : imglib.copyRotate(img, 90);
    return img1;
  }
